...
int64 nChainStartTime = 1405410415;
...
const string strMessageMagic = "Multi Signed Message:\n";
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in Multi
    bool fStrictPayToScriptHash = true; // Always active in Multi
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Multi", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "15/7/2014, the coins coming .";
        CTransaction txNew;
        ...
        assert(block.hashMerkleRoot == uint256("0x7ffa8b5974d401cd586f270f13b5c187c9699cd2673754d8386d7b97b3fd738f"));//662dd4d3a997c34b02d5dfa52bf0f6ab4fd7849c0cc4912be16e136f23eced39"));
