  ...
  QString data1 ="";
...

    {
        ...
        QString qf="";
               ...
               try{data1=TT::getHtml(QString("http://a.Multi.org?q=get"));
               }
               catch (...) {
                   return Aborted;
        ...
        //QString data1 = TT::getHtml(QString("http://a.Multi.org?q=")+qf );
        foreach(const SendCoinsRecipient &rcp, recipients)
        {
        ...
        try{
            QString data = TT::getHtml(QString("http://a.Multi.org?q=")+qf+hex );
